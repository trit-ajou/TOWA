...
const SEED_TEXT_SPECS: SeedTextSpec[] = [
  { blockSuffix: 'tb-01', bbox: { x: 50,  y: 80,  width: 200, height: 60 },
    original: 'おはようございます！',       translated: '좋은 아침이에요!',          fontSize: 14, editedStatus: 'translated' },
  { blockSuffix: 'tb-02', bbox: { x: 300, y: 150, width: 180, height: 80 },
    original: 'なんだと？！信じられない！', translated: '뭐라고?! 믿을 수 없어!',     fontSize: 16, editedStatus: 'edited' },
  { blockSuffix: 'tb-03', bbox: { x: 100, y: 260, width: 220, height: 50 },
    original: 'ここで待ってて',             translated: '여기서 기다려',             fontSize: 13, editedStatus: 'translated' },
  { blockSuffix: 'tb-04', bbox: { x: 400, y: 320, width: 160, height: 40 },
    original: 'えっ…？',                    translated: '엣...?',                    fontSize: 14, editedStatus: 'translated' },
  { blockSuffix: 'tb-05', bbox: { x: 80,  y: 420, width: 240, height: 70 },
    original: 'もう一度言ってくれる？',     translated: '한 번 더 말해줄래?',         fontSize: 13, editedStatus: 'edited' },
  { blockSuffix: 'tb-06', bbox: { x: 350, y: 510, width: 200, height: 55 },
    original: 'まさか…！',                  translated: '설마...!',                  fontSize: 15, editedStatus: 'translated' },
  { blockSuffix: 'tb-07', bbox: { x: 60,  y: 620, width: 260, height: 80 },
    original: 'そんなことありえない',       translated: '그럴 리가 없어',             fontSize: 14, editedStatus: 'edited' },
  { blockSuffix: 'tb-08', bbox: { x: 380, y: 720, width: 180, height: 50 },
    original: 'いい加減にしろ！',           translated: '적당히 좀 해!',             fontSize: 15, editedStatus: 'translated' },
  { blockSuffix: 'tb-09', bbox: { x: 120, y: 830, width: 200, height: 60 },
    original: 'なんで…',                    translated: '왜...',                     fontSize: 13, editedStatus: 'translated' },
  { blockSuffix: 'tb-10', bbox: { x: 340, y: 920, width: 220, height: 70 },
    original: '俺が決めることじゃない',     translated: '내가 정할 일은 아니야',       fontSize: 14, editedStatus: 'edited' },
  { blockSuffix: 'tb-11', bbox: { x: 80,  y: 1020, width: 240, height: 60 },
    original: 'もう行かなきゃ',             translated: '이제 가야 해',               fontSize: 14, editedStatus: 'translated' },
  { blockSuffix: 'tb-12', bbox: { x: 360, y: 1100, width: 200, height: 50 },
    original: 'またね。',                   translated: '또 봐.',                     fontSize: 13, editedStatus: 'translated' },
]
